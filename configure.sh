...
create_applets() {
    ...
    echo "/* not modify manually*/"
    echo
    echo "/* general includes */"
    echo '#include <stddef.h>'
    echo "#include \"lib/applet.h\""
    echo "#include \"fdbox.h\""
    echo 
    echo "/* applets includes */"
...
echo "Generating applets: $APPLETS"
